...
Read [IMPLEMENTATION_AUDIT.md](IMPLEMENTATION_AUDIT.md) before downloading or interpreting results. Raw datasets and generated reports stay local; they are never required to run the application.
