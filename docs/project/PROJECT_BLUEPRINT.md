...
> This is the long-form product and architecture vision. For the current implementation state and operational instructions, use the [root README](../../README.md), [canonical team ownership](TEAM_OWNERSHIP.md), [setup guide](../development/SETUP.md), and [documentation index](../README.md). Where an older example conflicts with those files, the focused current document is authoritative.
