package com.healthguardian.app.feature.sensors.domain
...
data class ReadingProvenance(
    ...
    val measurementMetadata: Map<String, Any> = emptyMap(),
)
...
sealed interface SensorReading {
    ...
    fun commonJson(temporalType: String, governance: ObservationGovernance?): JSONObject = JSONObject().apply {
        ...
        put(
            "metadata",
            JSONObject().apply {
                provenance.measurementMetadata.forEach { (key, value) -> put(key, value) }
