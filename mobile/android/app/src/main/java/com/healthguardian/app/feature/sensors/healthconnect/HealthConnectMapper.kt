...
import com.healthguardian.app.feature.sensors.domain.InstantReading
import com.healthguardian.app.feature.sensors.domain.IntervalReading
import com.healthguardian.app.feature.sensors.domain.ReadingProvenance
import com.healthguardian.app.feature.sensors.domain.SensorReading
import com.healthguardian.app.feature.sensors.domain.SeriesPoint
...
import com.healthguardian.app.feature.sensors.domain.SleepStage
...
object HealthConnectMapper {
    ...
    private fun provenance(record: Record): ReadingProvenance {
        ...
        return ReadingProvenance(
            ...
            measurementMetadata = if (record is SkinTemperatureRecord) buildMap {
