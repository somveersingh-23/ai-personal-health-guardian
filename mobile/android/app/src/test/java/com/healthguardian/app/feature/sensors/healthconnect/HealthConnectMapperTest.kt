...
class HealthConnectMapperTest {
    ...
    fun mapsSkinTemperatureRecordWithDeltaUnits() {
        ...
        val metadata = reading.toJson().getJSONObject("metadata")
        assertEquals(33.0, metadata.getDouble("baseline_celsius"), 0.001)
        assertEquals(SkinTemperatureRecord.MEASUREMENT_LOCATION_WRIST, metadata.getInt("measurement_location"))
    }
